...
const Visualization: React.FC<Props> = ({ results, layer }) => {
  ...
  return (
    <div className="bg-white p-12 rounded-[12px] border border-slate-100 shadow-sm flex flex-col h-full">
      <h2 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-10">Geometric Cross-Section</h2>

      <div className="relative flex-1 min-h-[160px] flex items-center justify-center bg-slate-50/50 rounded-[12px] border border-slate-100 overflow-hidden">
        {/* PCB Board Base */}
